...
from flaskjournal import app, db, bcrypt
from flaskjournal.forms import RegistrationForm, LoginForm, UpdateProfileForm
...
@app.route('/home')
def home():
	return render_template('home.html', posts=posts, h1="All posts")
